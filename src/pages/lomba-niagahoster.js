    ...
    <>
      ...
      <div className="md:mt-20 mt-16 md:px-20">
        <div className="grid grid-cols-12">
          <h1 className="md:text-5xl text-center  mb-8 col-span-12  text-4xl  text-white tracking-wide font-semibold leading-tight">Lomba Landing Page: Journey with Niagahoster</h1>
        ...
        <div className="mt-36 grid grid-cols-12 gap-8 items-center ">
          <div className="md:col-span-6 col-span-12">
            <h3 className="md:text-4xl text-2xl font-semibold text-white tracking-wide ">Overview</h3>
            ...
            <div className="flex items-center space-x-2 mt-2">
              <a target="_blank" rel="noreferrer" href="https://www.niagahoster.co.id/blog/lomba-landing-page/" className="text-lg font-semibold underline text-cyan-300 tracking-wide">
                Kunjungi artikel
              </a>
        ...
        <div className="col-span-12 mt-8 ">
          <p className="text-lg text-slate-400">Artikel berikut berisi tentang ketentuan lomba, peraturan dan informasi-informasi lainnya. Berdasarkan artikel tersebut, setidaknya ada 3 ketentuan konten website:</p>
          <ol type="1">
            <li className="text-lg text-slate-400 mt-2">
            ...
            <li className="text-lg text-slate-400 mt-2">2. Tulisan tidak boleh mengandung unsur pornografi, judi, sara atau tindakan yang melanggar hukum.</li>
            <li className="text-lg text-slate-400 mt-2">3. Tulisan harus original (karya sendiri), bukan plagiat ataupun copy paste.</li>
          </ol>
        </div>
        <div className="mt-36">
          <h3 className="md:text-4xl text-2xl font-semibold text-white tracking-wide">Mengapa akhirnya saya mengikuti lomba ini?</h3>
          <p className="text-lg text-slate-400 mt-2">
        ...
        <div className="mt-36">
          <h3 className="md:text-4xl text-2xl font-semibold text-white tracking-wide">My design proses</h3>
          <p className="text-lg text-slate-400 mt-2 mb-4">Karena ini hanya landing page yang berisi artikel, saya tidak memerlukan proses yang panjang. Kurang lebih ini proses saya dalam mendesain landing page kali ini:</p>
          <Image src={Designproses} />
        </div>
        <div className="mt-36">
          <h3 className="md:text-4xl text-2xl font-semibold text-white tracking-wide">Collect moodboard</h3>
          <p className="text-lg text-slate-400 mt-2 mb-4">
        ...
        <div className="mt-36">
          <h3 className="md:text-4xl text-2xl font-semibold text-white tracking-wide">Wireframe</h3>
          <p className="text-lg text-slate-400 mt-2 mb-8">
            Saya memang senang memulai wireframe dari coret-coretan kertas seperti foto di bawah ini, alasannya karena terasa lebih leluasa ketimbang menggunakan tools. Saya suka kutipan dari buku Petunjuk UX milik @halodesigners
            “High-fi memang tujuan akhir kita, namun low-fi tempatnya menemukan kejelasan (clarity) dari alur kerja yang product kita ingin capai.”
          </p>

          <Image src={Lowfidelity} />
          <p className="text-lg text-slate-400 mt-2 mb-8">Setelah coret-coret di kertas, barulah saya membuatnya menggunakan Figma.</p>
          <div className="gap-y-4 flex flex-col">
            <Image src={Wireframe1} />
            <Image src={Wireframe2} />
          </div>
          <p className="text-lg text-slate-400 mt-2 mb-8">Setelah membuat wireframe, saya memiliki 5 section yang berisi konten sesuai dengan kriteria pemenang, di antaranya adalah: </p>
          <ol type="1">
            <li className="text-lg text-slate-400 mt-2">1. Kesesuaian Tema, Kualitas Konten, Ide & Kreativitas Konten</li>
            <li className="text-lg text-slate-400 mt-2">2. Design website.</li>
            <li className="text-lg text-slate-400 mt-2">3. Memenuhi semua syarat ketentuan yang berlaku.</li>
          </ol>
          <p className="text-lg text-slate-400 mt-2 mb-4">
        ...
        <div className="mt-36">
          <h3 className="md:text-4xl text-2xl font-semibold text-white tracking-wide mb-8">Design High Fidelity</h3>
          ...
          <a rel="noreferrer" target="_blank" href="https://github.com/fasfashan/lomba-landing-page-niagahoster">
            <div className="px-4 flex gap-4 items-center py-2 border border-neutral-300 hover:bg-slate-800 rounded-md">
              <div>
                <Github />
              </div>
              <div className="flex  flex-col">
                <p className="font-medium text-white tracking-wide">lomba-landing-page-niagahoster</p>
                <p className="text-slate-400 text-sm">Fasfashan</p>
              </div>
            </div>
          </a>
        </div>
        <div className="mt-36">
          <h3 className="md:text-4xl text-2xl font-semibold text-white tracking-wide">Result</h3>
          <p className="text-lg text-slate-400 mt-2 mb-4">
