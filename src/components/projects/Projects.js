...
const Projects = () => {
  return (
    <section id="projects" className="mt-60 grid grid-cols-12 gap-6 space-y-6 items-center  ">
      ...
      <div data-aos="fade-up" data-aos-duration="1500" className="md:col-span-6 col-span-12 space-y-6">
        <Image src={Prowork} className="rounded-md " />
        <div className="space-y-2">
          <h2 className=" text-primary text-lg  font-semibold">Jual Beli Saham Mobile App</h2>
